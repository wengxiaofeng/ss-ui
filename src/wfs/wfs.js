...
class Wfs {
  ...
  static isSupported() {
    return (window.MediaSource &&
      ...
      window.MediaSource.isTypeSupported('video/mp4; codecs="avc1.42c02a"'));
  }
  ...
  attachMedia(media, channelName = 'chX', mediaType = 'H264Raw', websocketName = 'display', touch) { // 'H264Raw' 'FMp4'    
    console.log("attachMedia(media", media)
    this.mediaType = mediaType;
    this.media = media;
    this.trigger(Event.MEDIA_ATTACHING, { media: media, channelName: channelName, mediaType: mediaType, websocketName: websocketName, touch:touch });
  }

  attachWebsocket(websocket, channelName) {
    console.log("attachWebsocket", websocket, channelName)
